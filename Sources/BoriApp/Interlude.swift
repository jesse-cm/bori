...
enum Interlude {
    ...
    static let quotes: [Quote] = [
        ...
        Quote(text: "Courage is the price that life exacts for granting peace.", who: "Amelia Earhart"),
        ...
        Quote(text: "I was taught that the way of progress was neither swift nor easy.", who: "Marie Curie"),
        ...
        Quote(text: "You must do the thing you think you cannot do.", who: "Eleanor Roosevelt"),
        ...
        Quote(text: "You may not control all the events that happen to you, but you can decide not to be reduced by them.", who: "Maya Angelou"),
